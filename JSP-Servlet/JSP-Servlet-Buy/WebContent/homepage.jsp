		...
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<p id="contents" class="content">Để trở thành một chuyên gia
					...
					website phù hợp với hành vi của người dùng và khả năng của màn hình
					hiển thị. Nếu cho rằng cần tạo một phiên bản “mobile” cho website
					của mình, bạn hãy nghĩ lại. Thiết kế web thích ứng cung cấp một bản
					thiết kế có khả năng làm việc tốt với desktop, smartphone và nhiều
					thiết bị khác. HTML5, cũng như CSS3 vẫn đang tiếp tục hoàn thiện và
					cuốn sách này sẽ giúp bạn nắm được những khái niệm nền tảng về cách
					tổ chức, sáng tạo và phân phối nội dung web một cách hiệu quả thông
					qua những phương pháp tối ưu nhất.Cuốn sách này gồm 15 bài học,
					giúp bạn tìm hiểu các kiến thức HTM5 và CSS3 cơ bản và nâng cao để
					tạo các trang web thích ứng một cách hiệu quả. Các hướng dẫn từng
					bước được trợ giúp với video và mã nguồn thực hành từ gói tài
					nguyên kèm theo sách. Qua các bài học, bạn sẽ:- Học cách viết mã để
					tạo các trang web với tính năng vượt trội, giàu khả năng thích ứng
					nhờ các thẻ HTML5 mới- Xây dựng các form HTML5 và biết cách sử dụng
					form trong thực tế- Thêm các nội dung đa phương tiện có tính linh
					hoạt cao mà không cần đến plug-in trình duyệt- Sử dụng phần tử
					Canvas để tạo các hình với màu sắc, đường viền, hiệu ứng chuyển màu
					…- Kết hợp việc định kiểu và các tính năng hoạt hình mạnh mẽ của
					CSS3 để cải tiến trang web- Làm việc với các công nghệ hỗ trợ HTML5
					để xây dựng ứng dụng web dễ hơn bao giờ hết</p>
